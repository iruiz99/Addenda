...
class csNumeroATexto
{
    public static string Invocar(string num)
    {                
        string res, dec = "";
        Int64 entero;
        int decimales;
        ...
        if (decimales > 0)
        {
            ...
            dec = " PESOS " + string.Format("{0:00}", decimales) + "/100 M.N.";
        ...
        res = csNumeroATexto.NumeroALetras(Convert.ToDouble(entero)) + dec;
        return res;
    }
